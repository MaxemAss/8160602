...
<head profile="http://gmpg.org/xfn/11">
    ...
    <!-- Load Jquery Easing --><?Asset::getInstance()->
    addJs(SITE_TEMPLATE_PATH."/jquery.easing.js", true);?>
    ...
    <?Asset::getInstance()->
    addJs(SITE_TEMPLATE_PATH."/_include/js/pngfix.js", true);?>
    ...
    <?Asset::getInstance()->
    addCss(SITE_TEMPLATE_PATH."/_include/css/style-orange.css");?>

    <?Asset::getInstance()->
    addCss(SITE_TEMPLATE_PATH."/_include/css/style-redish.css");?>

    <?Asset::getInstance()->
    addCss(SITE_TEMPLATE_PATH."_include/css/style-dirtyblue.css");?>

    <?Asset::getInstance()->
    addCss(SITE_TEMPLATE_PATH."/_include/css/style-green.css");?>

    <?Asset::getInstance()->
    addCss(SITE_TEMPLATE_PATH."/_include/css/style-pink.css");?>


    <?Asset::getInstance()->
    addJs(SITE_TEMPLATE_PATH."/_include/js/styleswitch.js", true);?>
    <!-- End Load -->
        ...
        <div class="containit ornament-right">
            <div class="roundaboutshadow">
                ...
                <script type="text/javascript" charset="utf-8">
                    function roundaboutimage1(){  $.prettyPhoto.open('images/showcase/showcase1.jpg', 'title', 'Some Brilliant Project'); }
                    function roundaboutimage2(){  $.prettyPhoto.open('images/showcase/showcase2.jpg', 'title', 'Another One'); }
                    function roundaboutimage3(){  $.prettyPhoto.open('images/showcase/showcase3.jpg', 'title', 'This is Insane'); }
                    function roundaboutimage4(){  $.prettyPhoto.open('images/showcase/showcase4.jpg', 'title', 'Another Comment'); }
                    function roundaboutimage5(){  $.prettyPhoto.open('images/showcase/showcase5.jpg', 'title', 'This roundabout Rules'); }
                    function roundaboutimage6(){  $.prettyPhoto.open('images/showcase/showcase6.jpg', 'title', 'Awsome Commment'); }
                    function roundaboutimage7(){  $.prettyPhoto.open('images/showcase/showcase7.jpg', 'title', 'And Another One'); }
                </script>
